...
<template>
    ...
    <div class="content">
        <div class="container-fluid">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody v-if="clients.data.length > 0">
                        <ClientListItem v-for="(client, index) in clients.data" :key="client.id" :client=client
                            :index=index @edit-client="editClient" @confirm-client-deletion="confirmClientDeletion"
            ...
            <Pagination v-if="clients && clients.current_page && clients.last_page" :current-page="clients.current_page"
                :last-page="clients.last_page" :prev-url="clients.prev_page_url" :next-url="clients.next_page_url"
                @change-page="getClients" />
        </div>
    </div>

    <div class="modal fade" id="clientFormModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <Form ref="form" @submit="handleSubmit"
                    :validation-schema="editing ? editClientSchema : createClientSchema" v-slot="{ errors }"
                    :initial-values="editing ? formValues : form">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <Field name="office" type="office" class="form-control"
                                :class="{ 'is-invalid': errors.office }" id="office" />
